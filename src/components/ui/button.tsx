...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[#FA7921] text-white hover:bg-[#FA7921]/90 shadow-lg hover:shadow-xl transform hover:scale-[1.02]',
        destructive: 'bg-red-500 text-white hover:bg-red-600 shadow-md',
        outline: 'border border-gray-300 bg-white hover:bg-gray-50 hover:border-gray-400',
        secondary: 'bg-[#002233] text-white hover:bg-[#003344] shadow-md',
        ghost: 'hover:bg-gray-100 hover:text-gray-900',
        link: 'text-[#FA7921] underline-offset-4 hover:underline',
      },
      size: {
