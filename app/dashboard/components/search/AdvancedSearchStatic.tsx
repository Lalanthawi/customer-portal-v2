...
export default function AdvancedSearchStatic({ onSearch, onReset, className = '' }: AdvancedSearchStaticProps) {
  ...
  // Count active filters (no auto-search here)
  useEffect(() => {
    let count = 0
          ...
          <div className="px-4 py-4 border-t border-gray-200 bg-gray-50">
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-[#FA7921] to-[#FF9A56] text-white rounded-xl font-bold hover:shadow-lg transition-all hover:scale-[1.01]"
              >
