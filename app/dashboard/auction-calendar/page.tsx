...
const auctionHouseInfo: { [key: string]: { color: string, location: string, avgVehicles: number } } = {
  'USS': { color: '#3B82F6', location: 'Multiple', avgVehicles: 15000 },
  'TAA': { color: '#10B981', location: 'Multiple', avgVehicles: 8000 },
  'HAA': { color: '#8B5CF6', location: 'Kobe', avgVehicles: 12000 },
  'JU': { color: '#F97316', location: 'Multiple', avgVehicles: 6000 },
  'CAA': { color: '#EF4444', location: 'Multiple', avgVehicles: 4000 },
  'NAA': { color: '#6366F1', location: 'Multiple', avgVehicles: 3000 },
  'Honda': { color: '#64748B', location: 'Multiple', avgVehicles: 5000 },
  'MIRIVE': { color: '#14B8A6', location: 'Multiple', avgVehicles: 2500 },
  'Arai': { color: '#EC4899', location: 'Bayside/VT', avgVehicles: 2000 },
  'Bay': { color: '#06B6D4', location: 'Osaka', avgVehicles: 1500 },
  'JAA': { color: '#F59E0B', location: 'Hyogo', avgVehicles: 1800 },
  'LUM': { color: '#84CC16', location: 'Kobe', avgVehicles: 1200 },
  'ZIP': { color: '#F43F5E', location: 'Tokyo', avgVehicles: 2200 },
  'USSR': { color: '#6B7280', location: 'Nagoya', avgVehicles: 1000 }
}
