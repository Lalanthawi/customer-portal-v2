            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    { value: 'light', label: 'Light', icon: '☀️', bg: 'bg-white' },
                    { value: 'dark', label: 'Dark', icon: '🌙', bg: 'bg-gray-800' },
                    { value: 'auto', label: 'Auto', icon: '🌗', bg: 'bg-gradient-to-r from-white to-gray-800' }
                  ].map((theme) => (
                    <button
                      key={theme.value}
                    ...
                    >
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium mt-1">{theme.label}</p>
                      </div>
                      {generalSettings.theme === theme.value && (
              ...
              <div className="p-6">
                <div className="grid gap-4">
                  {[
                    ...
                    { name: 'Email Service', connected: false, icon: '📧' },
                    { name: 'SMS Gateway', connected: false, icon: '📱' }
                  ].map((service) => (
